...
const style={
    ...
    inputBox:`h-8 mx-4 border-2 bg-[#eeeeee] flex items-center my-1 py-1 px-2`,
    focusedInputBox:`border-black rounded`,
    input:`my-1 rounded-2 p-2 outline-none border-none bg-transparent h-full w-full`,
    verticalLine:`w-0 h-[1.4rem] border-black border absolute z-10 left-[2.05rem] top-[1.8rem]`,
}
...
const LocationSelector = () => {
  ...
  <div className={style.wrapper}>
    <div className={style.searchHeader}>
        {inFocus === 'from' ? 'Where can we pick you up?':'Where to Drop?'}
    </div>
